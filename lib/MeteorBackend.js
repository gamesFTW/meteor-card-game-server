...
Meteor.methods({
    ...
    playCardAsSpell: function(gameId, playedCardId, targetCardId) {
        ...
        if (fromTable && playedCard.attachable && isTargetCardTypeCreature && (isHaveMana || isGameNotStarted)) {
            ...
            // Tap mana
            if (untappedCardInManaPool) {
                Meteor.call('tapCard', gameId, untappedCardInManaPool._id)
            }
        }
    },
